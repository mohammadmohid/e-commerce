    ...
    <div className="flex min-w-max whitespace-nowrap gap-2 md:gap-4 items-center">
      <div className="relative">
        ...
        >
          ...
          <div className="group flex min-w-fit flex-shrink-0 items-center gap-2 px-3 py-2 rounded-lg transition-colors border-2 border-transparent hover:text-red-600 bg-[#F5F5F5] active:bg-red-600 active:text-brand-white hover:border-red-600 whitespace-nowrap">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
            ...
            <Link className="select-none" href="/logout">
              Logout
            </Link>
          </div>
        </div>
